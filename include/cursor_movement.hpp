...
#else
static inline void move_up(std::size_t lines) { std::cout << "\033[" << lines << "A"; }
static inline void move_down(std::size_t lines) { std::cout << "\033[" << lines << "B"; }
static inline void move_right(std::size_t cols) { std::cout << "\033[" << cols << "C"; }
static inline void move_left(std::size_t cols) { std::cout << "\033[" << cols << "D"; }
#endif
